    ...
    var Za = "IN_PROGRESS"
      ...
      , ts = function(e) {
        ...
        return o(t, [{
            key: "evaluateRow",
            value: function() {
                if (solutionLength === this.tileIndex && !(this.rowIndex >= 6)) {
            ...
            key: "addLetter",
            value: function(e) {
                this.gameStatus === Za && (this.canInput && (this.tileIndex >= solutionLength || (this.boardState[this.rowIndex] += e,
            ...
            value: function() {
                if (this.gameStatus === Za && this.canInput) {
                    if (solutionLength !== this.tileIndex)
            ...
            value: function() {
                ...
                for (var a = 0; a < 6; a++) {
                    ...
                    s.setAttribute("length", solutionLength),
